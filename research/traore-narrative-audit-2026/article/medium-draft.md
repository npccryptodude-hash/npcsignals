...
This investigation asked a different question:
...
**Reality → Interpretation → Amplification → Narrative Inflation → Synthetic Mythmaking**
...
What cannot be established from GDP data alone is that Ibrahim Traoré personally caused all of that expansion.
...
The first claim concerns inputs.

The second concerns outcomes.
...
These are significant policy developments.

But they do not establish that the entire mining industry has been nationalised.
...
**Whole mining sector nationalised: not supported.**
...
A November 2022 government record states that Traoré renounced the remuneration attached to the presidency and chose to retain his salary as an army captain.

Ministerial remuneration was also reduced.

But specialist verification found that the commonly repeated percentage was unreliable.

More importantly, no administrative evidence was found for a general **50 percent increase for public-sector workers**.

One viral package therefore contained:

- a documented fact
- a distorted fact
- an unsupported claim

Repeated together, they become difficult to separate.
...
Traoré has spoken about making education free.
...
Other examples include fabricated international agreements and synthetic speeches attributed to Traoré.

These cases are different from Narrative Inflation.

There is no tractor programme being exaggerated.

No factory being overinterpreted.

No motorway being prematurely completed.
...
A celebrity sings about him.

A foreign leader attacks him because he supposedly threatens established interests.
...
Nothing in the image itself needs to be fake.
...
**Direction-coded N = 47**

After related posts were grouped into independent narrative clusters:

| Direction | Independent narratives | Share |
|---|---:|---:|
| Pro-Traoré | 26 | 89.7% |
| Anti-Traoré | 3 | 10.3% |
...
The Validation Sample contained much more neutral material, which is methodologically important.

Among its clearly directional items:
...
The asymmetry replicated.

Its population-wide prevalence remains unresolved.
...
At least eight appeared to use AI-generated narration or scripts.

Ten displayed suspiciously similar behaviour and posted nearly identical material.
...
It does **not** establish that every pro-Traoré account belongs to one network.
...
**Distribution should not be confused with authorship.**

---

# The political record also matters

A study of the Traoré information environment cannot examine economic achievements while excluding political developments that complicate the heroic online narrative.

Traoré took power in a military coup in September 2022.
...
Government sources can be strong evidence that:

- a factory opened
- a programme was announced
- equipment was purchased
- a road project began

They are weaker evidence for questions such as:

- whether the programme achieved its long-term objectives
- whether spending was efficient
- whether the social effects were as large as authorities claim
...
It does not establish that his government directs the broader misinformation ecosystem.

It does not establish that Russia controls all pro-Traoré amplification.
...
**The internet is revealing a transformation ignored by traditional media.**

The evidence supports something more precise.

> **The documented record and the mythology are not opposites.**
>
> **The mythology often works because a documented record exists underneath it.**

A tractor programme exists.

A textile factory exists.

A motorway project exists.

A gold refinery project exists.
...
A construction site becomes completed infrastructure.

A real improvement becomes an economic miracle.
